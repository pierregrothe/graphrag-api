...
class GraphRAGDashboards:
    ...
    def create_overview_dashboard() -> GrafanaDashboard:
        ...
        dashboard = GrafanaDashboard(
            ...
            "High-level overview of GraphRAG API performance and health"
        )
    ...
    def create_graphql_dashboard() -> GrafanaDashboard:
        ...
        """
        dashboard = GrafanaDashboard(
            "GraphRAG API - GraphQL",
            "GraphQL query performance and optimization metrics"
        )
    ...
    def create_cache_dashboard() -> GrafanaDashboard:
        ...
        """
        dashboard = GrafanaDashboard(
            "GraphRAG API - Cache Performance",
        ...
        dashboard.add_panel({
            ...
            "type": "graph",
            "targets": [{
                "expr": "graphrag_cache_size_bytes",
        ...
        dashboard.add_panel({
            ...
            "type": "graph",
            "targets": [{
                "expr": "graphrag_cache_entries_total",
                "legendFormat": "{{cache_type}}"
            }],
    ...
    def create_system_dashboard() -> GrafanaDashboard:
        ...
        dashboard.add_panel({
            ...
            "type": "graph",
            "targets": [{
                "expr": "graphrag_memory_usage_bytes",
                "legendFormat": "{{type}}"
            }],
            "gridPos": {"h": 8, "w": 12, "x": 12, "y": 0},
            "yAxes": [{
        ...
        dashboard.add_panel({
            ...
            "targets": [
                ...
                {
                    "expr": "graphrag_db_connections_idle",
                    "legendFormat": "Idle"
                }
            ],
            "gridPos": {"h": 8, "w": 24, "x": 0, "y": 8}
