...
class TestBenchmarkSuite:
    ...
    def test_scenario_results_aggregation(self, benchmark_suite):
        ...
        user_results = [
            [
                {"scenario": "test_scenario", "success": True, "status_code": 200, "response_time": 0.1, "timestamp": 1000.0},
                {"scenario": "test_scenario", "success": True, "status_code": 200, "response_time": 0.2, "timestamp": 1000.1},
                {"scenario": "other_scenario", "success": False, "status_code": 500, "response_time": 0.5, "timestamp": 1000.2},
            ],
            [
                {"scenario": "test_scenario", "success": False, "status_code": 404, "response_time": 0.3, "timestamp": 1000.3},
            ]
        ]
