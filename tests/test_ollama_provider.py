...
class TestOllamaGraphRAGLLM:
    ...
    async def test_generate_text_success(self):
        ...
        with patch.object(self.provider.client, 'generate', new_callable=AsyncMock) as mock_generate:
    ...
    async def test_generate_embeddings_success(self):
        ...
        with patch.object(self.provider.client, 'embeddings', new_callable=AsyncMock) as mock_embeddings:
    ...
    async def test_generate_embeddings_failure(self):
        ...
        with patch.object(self.provider.client, 'embeddings', new_callable=AsyncMock) as mock_embeddings:
            ...
            with pytest.raises(Exception, match="Ollama embedding generation failed: Embedding failed"):
    ...
    async def test_health_check_missing_models(self):
        ...
        mock_models_response = {
            "models": [
                {"name": "llama2:7b"}  # Missing our required models
            ]
        }
